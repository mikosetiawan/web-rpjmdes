    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 py-6">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
            ...
            <div class="mb-4">
                ...
                <a href="{{ route('tim-penyusun.print') }}" target="_blank"
                    class="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 no-print">
                    Cetak Dokumen
                </a>
            </div>
                        ...
                        @forelse ($timPenyusuns as $tim)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <form action="{{ route('tim-penyusun.destroy', $tim->id) }}" method="POST"
