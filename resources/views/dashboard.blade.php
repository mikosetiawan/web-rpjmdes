                ...
                @forelse ($recentActivities as $activity)
                    <div class="flex items-center space-x-4 p-3 bg-gray-50 rounded-lg">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-sm text-gray-600">{{ $activity['timestamp']->translatedFormat('H:i, d M Y') }}
                            </p>
                        </div>
                    </div>
                @empty
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="py-3 px-4 text-center text-gray-600">Belum ada data potensi inventarisir.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
