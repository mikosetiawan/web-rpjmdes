<x-app-layout title="Tambah Jenis Kegiatan Baru">
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <h2 class="font-semibold p-3 text-xl text-gray-800 leading-tight">Tambah Jenis Kegiatan Baru</h2>
                <hr>
                    ...
                    <form action="{{ route('jenis-kegiatan.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_kegiatan" id="nama_kegiatan" value="{{ old('nama_kegiatan') }}"
                                class="mt-1 block w-full border-gray-300 p-2 border rounded-md shadow-sm" placeholder="Masukkan nama kegiatan.." autofocus>
                            @error('nama_kegiatan')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
